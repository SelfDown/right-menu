...
type ItemType = AttrsType & ElementType;
type UlType = {
    type: 'ul';
    text: string;
    disabled?: boolean;
...
type ElementType = HrType | LiType | UlType;
...
type OptionsType = ItemType[] | ((e: Event, config: ConfigType) => ItemType[] | Promise<ItemType[]>);
...
export { type ConfigType, type OptionsType, RightMenu as default };
